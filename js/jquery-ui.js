...
function Datepicker() {
	...
	"Julio","Agostot","Septiembre","Octubre","Noviembre","Diciembre" ], // Names of months for drop-down and formatting
		monthNamesShort: [ "Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic" ], // For formatting
		dayNames: [ "Domigo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado" ], // For formatting
